      ...
      <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
        <div>
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <Link to={'/'}> 
            <h2 className="text-2xl hover:animate-spin text-center cursor-pointer w-10 h-10 flex items-center justify-center font-bold bg-dark rounded-full outline outline-offset-4">S</h2> 
            </Link>
